        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold">HealthCare Plus</span>
            </div>
            <p className="mt-4 text-gray-400">
              Providing quality healthcare services with a personal touch. Your health is our priority.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#doctors" className="text-gray-400 hover:text-white">Doctors</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">General Check-ups</li>
